...
`} />
                    ...
                    <Element name="section3" className="element " id='section3'>
                        ...
                        <h2>Reference</h2>
                        <p> [7]Lemkul, J. A. (2024). Introductory Tutorials for Simulating Protein Dynamics with GROMACS. The Journal of Physical Chemistry B. https://doi.org/10.1021/acs.jpcb.4c04901</p>

                        <p>[8]Tian Lu, Sobtop, Version [1.0(dev5)], http://sobereva.com/soft/Sobtop (accessed on 02/10/2024)</p>
                        <p>[9] Hu, X., Zeng, Z., Zhang, J., Wu, D., Li, H., & Geng, F. (2022). Molecular dynamics simulation of the interaction of food proteins with small molecules. Food Chemistry, 405, 134824.</p>

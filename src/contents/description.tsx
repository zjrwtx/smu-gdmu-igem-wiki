  ...
  return (
    ...
    <div className="side-navbar">
      <Nav className="flex-column">
        <Nav.Link as={Link} to="section1" smooth={true} duration={500} className={activeLink === 'section1' ? 'active' : 'notActive'}>Abstract</Nav.Link>
        <Nav.Link as={Link} to="section2" smooth={true} duration={500} className={activeLink === 'section2' ? 'active' : 'notActive'}>Focusing on Hepatic Encephalopathy (HE)</Nav.Link>
        <Nav.Link as={Link} to="section3" smooth={true} duration={500} className={activeLink === 'section3' ? 'active' : 'notActive'}>Current Situation Pathogenic mechanism of HE</Nav.Link>
        <Nav.Link as={Link} to="section4" smooth={true} duration={500} className={activeLink === 'section4' ? 'active' : 'notActive'}>Limitation of current treatments</Nav.Link>
        <Nav.Link as={Link} to="section5" smooth={true} duration={500} className={activeLink === 'section5' ? 'active' : 'notActive'}>Project Goal and Design</Nav.Link>
      ...
      <div className="row  bg-rice_yellow">
        ...
        <div className="col-10">
              ...
              <p className='indent'>A healthy liver is able to maintain blood ammonia levels at low levels of 35-50 uM through the urea cycle. However, in cirrhosis, factors and other molecules (e.g., ammonia) that are normally prevented by the body from crossing the blood-brain barrier are able to naturally cross the blood-brain barrier, fill the brain, and stimulate pathophysiological pathways that can have deleterious effects. Neurological damage and cognitive decline due to liver dysfunction are the result of blood-borne factors that affect blood-brain barrier permeability and/or alter blood-brain barrier integrity[7-8]. </p>
               ...
               <Element name="section4" className="element rounded-border" id='section4'>
                 ...
                 <p className='indent'>The general pharmacological approach to treat HE included osmotic laxatives[8], anti-microbial agents[9], albumin and extracorporeal albumin dialysisprobiotics[10], L-Mentholated Ornithine (LOLA) [11]and so on. In recent years probiotic therapies have emerged as revolutionary treatment approaches. However, these conventional cancer treatment methods still exhibit several limitations (Table 1).</p>
                  ...
                  <div className='image-container'>
                  <img
                src="https://static.igem.wiki/teams/5378/description2/table1.webp"
                alt="example"
                className="image-wide"
              />
              ...
              <figcaption className='caption'>Figure 3. Overall design of our project</figcaption>
               ...
               <p className='indent'>We conducted broad investigations into the determination of reliable risk factors as a proper sensor for our project and after 3 engineering cycles (see details of our design in <a href='https://2024.igem.wiki/smu-gdmu-china/engineering'><span className='bold-font'>Engineering Page</span></a> ) and successfully came to final design in <span className='bold-font'>Figure 4</span>.</p>
              ...
              <p className='indent'>We designed several ways to metabolize the pathogenic factors in HE but only succeeded in expressing GS enzyme to metabolic ammonia in this iGEM cycle this year (see details of our efforts in <a href='https://2024.igem.wiki/smu-gdmu-china/engineering'><span className='bold-font'>Engineering Page</span></a>) . </p>

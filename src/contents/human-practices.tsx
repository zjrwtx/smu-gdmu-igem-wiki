...
<Element name="section3" className="element rounded-border" id='section3'>
  ...
  <div className="rounded-border">
    ...
    <p className='indent'>
      We were invited to the <span className='bold-font'>11th China Regional iGEMer Exchange Conference(CCIC)</span>, engaging in in-depth discussions with other teams to optimize and improve our project, enhancing <span className='bold-font'>collaboration abilities</span> and promoting mutual project development.
    </p>
